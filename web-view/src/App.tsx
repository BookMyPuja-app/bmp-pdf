import A4Print from "../../src/A4Print";
...
function App() {
  ...
  return (
    ...
    <div style={{
     ...
     <PDFViewer children={<A4Print data={data} dates={[(new Date("Feb 20 2005")).toISOString(), (new Date()).toISOString()]} />}  style={{width: "100%", maxWidth: "800px"}} />
    </div>
    </>
  )
}
